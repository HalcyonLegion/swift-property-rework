  ...
  async function updateLots() {
    try {
        const params = new URLSearchParams({
            EndDateTimeFrom: '2025-11-28', // Setting this to the same as Update Lots as EndDatetime should be From AFTER the previous auction to make sure the old lots aren't included
            IsShownOnWeb: true
        });
